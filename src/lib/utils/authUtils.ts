...
export const getUserRole = async (supabaseClient: SupabaseClient, userId: string): Promise<UserRoleProps>  => {
...
export const checkIfAuthorized = async (supabase: SupabaseClient, userId: string, authorizedRoles: UserRoleProps[]) => {
